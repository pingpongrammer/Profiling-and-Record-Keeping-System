...
public function updateInfo(Request $request, RequestCertificate $cer){
    $formFields = $request->validate([
        'remarks'       => 'nullable',
        'orNum'         => 'required',
        'cnNum'         => 'required',
  ...
  $cer->update($formFields);

      ActivityLog::log(
        'added control number, remarks and control number in certificate requested by  ' .
          $cer->fullname ,
        'request certificate',
        $cer->id
      );
