...
public function searchHousehold(Request $request){
 ...
 $request->validate([
  ...
  'add_booster_date' =>'required', 
  'add_booster_vaccine' =>'required', 
  'vaccine_image' => ['required','image'],
  ...
  if($request->hasFile('booster_image')){
    $image2= $request->file('booster_image')->store('images', 'public');
      ...
      $vaccinated->add_booster_date= json_encode($request->add_booster_date);
      $vaccinated->add_booster_vaccine= json_encode($request->add_booster_vaccine);
      // dd($vaccinated);
      $vaccinated->save();
