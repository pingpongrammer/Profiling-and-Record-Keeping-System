...
<main id="main">
                    ...
                    <div class="col-md-12">
                      <div class="card shadow mb-4">
                       ...
                       <form action="/storeVaccinationFully" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-12">
                        <button id="addRow" type="button" class="btn btn-info">Add Booster Record</button>
                        </div>
  ...
  <script type="text/javascript">
    ...
    $("#addRow").click(function () {
        ...
        html += '<label class="labelImage h4">Date of Booster<span style="color: red">*</span></label>';
        html += '<input type="date"  name="add_booster_date" class="form-control" value="{{old('add_booster_date')}}" required autocomplete="second_booster_date">';
        html += '</div>';
        html += '<div class="form-group col-md-6">';
        html += '<label class="labelImage h4">Booster Type of Vaccine<span style="color: red">*</span></label>';
        html += '<select class="form-control" name="add_booster_vaccine" value="{{old('add_booster_vaccine')}}" required autocomplete="first_booster">';
        ...
        html += '<option value="Janssen">Janssen</option>';
        html += '<option value="Novavax">Novavax</option>';
        html += '</select>';
        html += '</div>';
        // html += '<div class="form-group col-md-2">';
        // html += '<label class="labelImage h4">Date of 2nd Booster<span style="color: red">*</span></label>';
        // html += '<button id="removeRow" type="button"  class="btn btn-danger "><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></button>';
        html += '</div>';
