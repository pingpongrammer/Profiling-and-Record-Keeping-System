      ...
      <div class="card shadow mb-4">
        <div class="card-body" style="background-color: rgba(230, 181, 46, 0.966)">
          <div class="row align-items-center">
            <div class="col">
              <small class="text-muted mb-1" style="color: #f8f8f8 !important;">Household</small>
    ...
    <div class="col-md-4">
      <div class="card shadow mb-4">
        <div class="card-body" style="background-color: rgba(230, 58, 46, 0.966)">
          <div class="row align-items-center">
            <div class="col">
              <small class="text-muted mb-1" style="color: #f8f8f8 !important;">Population</small>
    ...
    <div class="col-md-4">
      <div class="card shadow mb-4">
        <div class="card-body" style="background-color: rgba(32, 139, 211, 0.966)">
          <div class="row align-items-center">
            <div class="col">
              <small class="text-muted mb-1" style="color: #f8f8f8 !important;">Male</small>
    ...
    <div class="col-md-4">
      <div class="card shadow mb-4">
        <div class="card-body" style="background-color: rgba(230, 46, 92, 0.966)">
          <div class="row align-items-center">
            <div class="col">
              <small class="text-muted mb-1" style="color: #f8f8f8 !important;">Female</small>
              <h3 class="card-title mb-0" style="color: #f8f8f8 !important;">{{ $female ?? '0'}}</h3>

            </div>
            <div class="col-4 text-right">
              <i class="fas fa-female" style="color: #f8f8f8 !important;"></i>
            </div>
          </div> <!-- /. row -->
        </div> <!-- /. card-body -->
      </div> <!-- /. card -->
    ...
    <div class="col-md-4">
      <div class="card shadow mb-4">
        <div class="card-body" style="background-color: rgba(215, 46, 230, 0.966)">
          <div class="row align-items-center">
            <div class="col">
              <small class="text-muted mb-1" style="color: #f8f8f8 !important;">Voter</small>
              <h3 class="card-title mb-0" style="color: #f8f8f8 !important;">{{ $voter ?? '0'}}</h3>

            </div>
            <div class="col-4 text-right">
              <i class="fas fa-user-plus" style="color: #f8f8f8 !important;"></i>
            </div>
          </div> <!-- /. row -->
        </div> <!-- /. card-body -->
      </div> <!-- /. card -->
    ...
    <div class="col-md-4">
      <div class="card shadow mb-4">
        <div class="card-body" style="background-color: rgba(51, 167, 151, 0.966)">
          <div class="row align-items-center">
            <div class="col">
              <small class="text-muted mb-1" style="color: #f8f8f8 !important;">Non Voter</small>
              <h3 class="card-title mb-0" style="color: #f8f8f8 !important;">{{ $nonvoter ?? '0'}}</h3>

            </div>
            <div class="col-4 text-right">
              <i class="fas fa-user-minus" style="color: #f8f8f8 !important;"></i>
            </div>
          </div> <!-- /. row -->
        </div> <!-- /. card-body -->
      </div> <!-- /. card -->
    ...
    <div class="col-md-4">
      <div class="card shadow mb-4">
        <div class="card-body" style="background-color: rgba(135, 230, 46, 0.966)">
          <div class="row align-items-center">
            <div class="col">
              <small class="text-muted mb-1" style="color: #f8f8f8 !important;">Senior Citizen</small>
    ...
    <div class="col-md-4">
      <div class="card shadow mb-4">
        <div class="card-body" style="background-color: rgba(255, 174, 0, 0.966)">
          <div class="row align-items-center">
            <div class="col">
              <small class="text-muted mb-1" style="color: #f8f8f8 !important;">PWDs</small>
