         ...
         @endif
            ...
            <div class="col-12 pt-5 pb-3">
              ...
              <a href="{{url('decline-certificate/'.$clearance->id)}}" class="btn btn-danger" style="margin-left:40%; width: 100px;">Declined</a>
                @if ($clearance->doctype == 'Barangay Clearance')
                <a href="{{url('certificateOfClearance/barangayClearance',$clearance->id)}}" type="submit" style="margin-left:2%; width: 100px;" class="btn btn-success">Approve</a>
                @elseif ($clearance->doctype == 'Certificate of Indigency')
                <a href="{{url('certificateOfIndigency/barangayIndigency/'.$clearance->id)}}" type="submit" style="margin-left:2%; width: 100px;" class="btn btn-success">Approve</a>
                @elseif ($clearance->doctype == 'Certificate of Residency')
                <a href="{{url('certificateOfResidency/barangayResidency',$clearance->id)}}" type="submit" style="margin-left:2%; width: 100px;" class="btn btn-success">Approve</a>
                @endif
            </div>
