                ...
                <div class="col-md-12">
                  ...
                  <p class="mt-3 fs-6" style="text-indent: 40px;">
                    ...
                    <div class="col-7">
                        ...
                        <div class="row">
                            <div class="col-5 fs-6">
                                <p class="fw-bold" style="text-indent: 40px; text-align: left;">Control Number</p>
                            </div>
                            <div class="col-5 fs-6">
                  ...
                  <div class="col-5">
                   ...
                   <p class="mt-3 fs-6" style="text-indent: 40px;">This certification issued from the purpose {{$cer->purpose}} of valid for 5 months from date issued.</p>
            ...
            @method('PUT')
              <div class="form-group">
                ...
                <select class="form-control" name="remarks" id="remarks" required>
                    <option class="default" value="Payment Method">{{$certificate->remarks}}</option>
