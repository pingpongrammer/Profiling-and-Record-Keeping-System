...
<style>
  body{
    /* background-image: url("assets/barangay-hall.png"); */
...
<body>
    <div class="registration-form">
        <form method="POST" action="/login/auth" >
          ...
          <p class="mt-2 mb-3" style="color: white">Don't have an account? <a href="/register2" style="text-decoration:none">Register</p></a>
